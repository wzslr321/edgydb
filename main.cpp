...
//
// Zwraca wartość w zależności od tego czy istnieje połączenie (niebezpośrednie) między node'ami o podanych id
// Przykład: IS 2 CONNECTED TO 3
// IS [node.id] CONNECTED TO [node.id]
//
// Zwraca wartość w zależności od tego czy istnieje połączenie pośrednie między node'ami o podanych id
